...
class LetvSpider(object):
    COMMENT_URL = 'http://api.my.le.com/vcm/api/list?jsonp=jQuery19108436476615905741_1570522231541&type=video&rows=20&page=1&sort=&cid=2&source=1&xid=1578861&pid=73868&ctype=cmt%2Cimg%2Cvote&listType=1&_=1570522231548'
    HEADERS = {
...
if __name__ == '__main__':
    spider = LetvSpider('http://www.le.com/ptv/vplay/1578861.html?ref=jrjd_pc')